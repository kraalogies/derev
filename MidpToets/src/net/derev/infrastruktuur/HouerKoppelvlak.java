...
public interface HouerKoppelvlak {
	Object gee(Class koppelvlak) throws InstantiationException, IllegalAccessException;
	void registreerEnkeling(Class koppelvlak, Object objek);
	void verwyder(Class koppelvlak);
	Keuselys geeKeuselys() throws Exception;
	Kultuur geeKultuur() throws Exception;
}
