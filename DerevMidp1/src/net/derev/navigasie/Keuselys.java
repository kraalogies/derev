...
public interface Keuselys {
	void registreer(Command bevel, Aksie aksie);
	void stelNuweSkermOp(Displayable skerm, SkermSpesifikasie kontroleKenmerke) throws Exception;
	void gaanTerug() throws Exception;
	void gooiBroodKrummel(SkermSpesifikasie spes);
	void vergeetLaaste();
}
