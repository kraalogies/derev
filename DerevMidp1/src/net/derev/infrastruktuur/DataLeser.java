...
public interface DataLeser {
	String leesString(String uri) throws IOException;
	Image geeBeeld(String uri);
	String leesLokaleString(String uri, String taalKode, String landKode) throws IOException;
}
